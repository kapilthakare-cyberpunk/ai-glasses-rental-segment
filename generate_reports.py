...
MODELS = [
    {
        ...
        "retail_inr": "Rs.39,900 – Rs.45,700",
    ...
    },
    {
        ...
        "rental_conservative": "Rs.350–400/day",
        "rental_premium": "Rs.450–500/day",
    ...
    },
    {
        ...
        "cons": "Heavy case (178 g); Rs.41,800 price; niche sport audience",
        "rental_conservative": "Rs.450–500/day",
        "rental_premium": "Rs.650–750/day",
        "recommendation": "PHASE 2 - Add after validating initial demand"
    },
    {
        "name": "Oakley Vanguard Meta",
        "category": "Rugged / Outdoor",
        "retail_inr": "Rs.52,300",
        "camera": "12 MP ultra-wide",
        "video": "1080p @ 30fps",
        "battery": "~4 hours",
        "weight_frame": "66 g",
        ...
        "cons": "Heaviest frame (66 g); highest price Rs.52,300; niche outdoor audience",
        "rental_conservative": "Rs.550–650/day",
        "rental_premium": "Rs.800–900/day",
    ...
    },
    {
        ...
        "retail_inr": "Rs.25,000 – Rs.27,500 (est.)",
        "camera": "12 MP ultra-wide",
        "video": "1080p @ 30fps",
        "battery": "~4 hours",
        "weight_frame": "~45 g",
        ...
        "rental_conservative": "Rs.400–450/day",
        "rental_premium": "Rs.550–650/day",
...
PROS = [
    "High rental yield (Rs.400–900/day vs Rs.800–1,200/day for lenses)",
...
CONS = [
    "High upfront cost (Rs.22,400–Rs.52,300 per unit)",
    "Tech obsolescence risk - new models every 12–18 months",
    "Damage/loss exposure (Rs.40,000+ replacement)",
...
OPEN_QUESTIONS = [
    "Will Pune customers pay Rs.500–900/day for smart glasses vs Rs.800–1,200/day for camera lenses?",
    "Is the fashion/tech crossover appeal strong enough in Pune's market?",
    "Can we establish reliable insurance coverage for Rs.40,000+ items?",
...
MARKET_SIGNALS = [
    ...
    ("Pune Camera Rental Market", "Rs.15–25 Cr est.", "Growing 15–20% YoY"),
    ("No Pune AI Glasses Operator", "Confirmed", "Zero direct competition currently"),
    ("Event Industry Pune", "Rs.500+ Cr", "Weddings, corporate, college fests"),
]
...
def build_overview_items():
    items = [
        ...
        ("Investment Range", "Rs.80,000 – Rs.1,60,000 (2–4 units)"),
        ("Daily Rental", "Rs.500 – Rs.900/day (premium tier)"),
...
def build_market_body():
    ...
    <table>
      ...
      <tbody>
        <tr><td>DSLR Camera Body</td><td>Rs.800 – Rs.1,200/day</td><td>Higher price, similar tech appeal</td></tr>
        <tr><td>GoPro / Action Cam</td><td>Rs.500 – Rs.800/day</td><td>Direct competitor for vloggers</td></tr>
        <tr><td>Premium Sunglasses (non-smart)</td><td>Rs.200 – Rs.400/day</td><td>Lower value, fashion-only</td></tr>
        <tr><td>AI Smart Glasses (new)</td><td>Rs.500 – Rs.900/day</td><td>Our proposed pricing - tech + fashion</td></tr>
      </tbody>
    </table>
    '''
...
def build_entry_notes():
    return '''<div class="callout">
      ...
      <div class="callout-body">
        <strong>Start small:</strong> 2× Ray-Ban Meta Wayfarer Gen 2 (Clear lens) for Rs.80,000–Rs.92,000 total investment.
...
def fill_short_brief(template_path):
    ...
    replacements = {
        ...
        <li><strong>Healthy rental yield</strong> - Rs.500–900/day vs Rs.80K–Rs.52K purchase cost (25–35 rentals to break even)</li>
        <li><strong>Start small, validate</strong> - 2× Gen 2 units, Rs.80K–Rs.92K total, 30–60 day test period</li>
    ...
    <table>
      ...
      <tbody>
        <tr><td><strong>Wayfarer Gen 2</strong> (Clear)</td><td>Rs.45,700</td><td>Rs.850</td><td>Rs.750/day</td><td>Rs.600/day</td><td>Rs.500/day</td></tr>
        <tr><td><strong>Wayfarer Gen 2</strong> (G-15)</td><td>Rs.39,900</td><td>Rs.750</td><td>Rs.650/day</td><td>Rs.525/day</td><td>Rs.425/day</td></tr>
      </tbody>
    </table>
    ...
    <table>
      <thead><tr><th>Model</th><th>Retail</th><th>1-Day</th><th>2-4 Days</th><th>5-8 Days</th><th>9+ Days</th></tr></thead>
      <tbody>
        <tr><td><strong>Oakley HSTN</strong></td><td>Rs.41,800</td><td>Rs.750</td><td>Rs.650/day</td><td>Rs.525/day</td><td>Rs.425/day</td></tr>
        <tr><td><strong>Oakley Vanguard</strong></td><td>Rs.52,300</td><td>Rs.900</td><td>Rs.775/day</td><td>Rs.650/day</td><td>Rs.525/day</td></tr>
      </tbody>
    </table>
    ...
    <table>
      ...
      <tbody>
        <tr><td>Initial Investment (2 units)</td><td>Rs.80,000</td><td>Rs.92,000</td></tr>
        <tr><td>Avg. Daily Rate</td><td>Rs.500–600</td><td>Rs.750–850</td></tr>
        <tr><td>Break-Even Rentals/Unit</td><td>~30–35</td><td>~25–30</td></tr>
        <tr><td>Monthly Revenue (2 units @ 30% util.)</td><td>Rs.9,000–Rs.10,800</td><td>Rs.13,500–Rs.15,300</td></tr>
